...
public class MilieuxApiGatewayApplication {
	...
	public static void main(String[] args) {
		...
		System.setProperty("SPRING_CLOUD_GATEWAY_GLOBALCORS_CORS_CONFIGURATIONS___ALLOWEDORIGINS",
				dotenv.get("SPRING_CLOUD_GATEWAY_GLOBALCORS_CORS_CONFIGURATIONS___ALLOWEDORIGINS", "*"));
