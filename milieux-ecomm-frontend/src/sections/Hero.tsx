...
const Hero = () => {
  ...
  const [ui_images, setUi_images] = useState<string[]>(
    storeInfo.ui_images?.length ? storeInfo.ui_images : defaultImages
  );
  ...
  return (
    <>
      <section
        id="home"
        className="w-full flex xl:flex-row flex-col justify-center h-[800px] gap-10 max-container"
      >
        <div className="relative xl:w-2/5 flex flex-col justify-start items-start w-full max-xl:padding-x pt-28">
          <h1 className="mt-2 z-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[82px] font-bold">
            ...
            <br />
            <span style={{ color: accentColor }} className="inline-block mt-3">
              {name}
            </span>
          </h1>
        ...
        <div
          className="relative flex-1 flex justify-center items-center xl:min-h-full max-xl:py-40 bg-hero bg-cover bg-center"
          style={{ backgroundColor: ui_secondary_color }}
        >
