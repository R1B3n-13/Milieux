...
const PORT = ecommBackend ? process.env[ecommBackend] : "http://localhost:8082/api";
  ...
  return (
    <div className="flex flex-col items-center w-full">
      <h1 className="font-bold text-xl pb-5 pt-[-5rem]">Orders</h1>
      <div className="flex flex-row justify-center border-gray-200 gap-2 items-center bg-gray-200 p-2 w-fit-content rounded-2xl px-2">
        <Button
          className="text-xl px-2 py-3 rounded-xl"
        ...
        <Button
          ...
          style={{
            backgroundColor: pendingOrders ? "#FFFFFF" : "transparent",
          }}
        ...
        <Button
          className="text-xl px-4 py-6 rounded-xl"
          style={{
            backgroundColor: shippedOrders ? "#FFFFFF" : "transparent",
          }}
              ...
              <li key={order.id} className="p-4 bg-white shadow rounded">
                <div className="flex flex-row justify-between">
                  ...
                  <div className="flex flex-col gap-2 w-[15%]">
                    <Button className="border-gray-200 bg-white border-[1px] hover:bg-gray-200">
                      {" "}
                      Details{" "}
                    </Button>
                    {order.status === 0 && (
                      <Button
                        ...
                        className="border-gray-200 bg-white border-[1px] hover:bg-gray-200"
                      >
                        {" "}
                        Ship{" "}
                      </Button>
