...
const CustomizeUiType = () => {
	...
	const { storeInfo, setStoreInfo, loading } = useStoreContext();
	const [uiType, setUiType] = useState(0)
	const carouselPath = 'https://res.cloudinary.com/dify5wcxm/image/upload/v1726766330/ibxbsj4qpckmmvpuiuwm.png'
	const staticImagePath = 'https://res.cloudinary.com/dify5wcxm/image/upload/v1726767655/osruln7kmmtat0jkamz4.png'
    ...
    return (
        <>
            <div className='flex justify-center items-center h-full'>
                ...
                <div className='flex flex-col w-max h-max p-5 justify-center items-center gap-10 
                rounded-3xl border-[1.5px] border-gray-200 shadow-2xl shadow-gray-200 '>
                    ...
                    <div className='flex w-[90%] gap-5 justify-center items-center bg-white'>
                        <Button variant={'ghost'} onClick={() => setUiType(2)}
                            className='w-[300px] h-[300px] p-0'
                            style={{ backgroundColor: uiType === 2 ? '#e6e6e6e6' : '#FFFFFF' }}>
                        ...
                        <Button variant={'ghost'} onClick={() => setUiType(1)}
                            className='w-[300px] h-[300px] p-0'
                            style={{ backgroundColor: uiType === 1 ? '#e6e6e6e6' : '#FFFFFF' }}>
                            <div className='flex flex-col border-[1.5px] border-gray-200 rounded-2xl justify-center items-center w-full h-full'>
                                <Image
                                    src={staticImagePath}
                                    alt="static images"
