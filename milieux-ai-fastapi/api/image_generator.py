...
async def generate_image(request: Request):
    try:
        ...
        if image_generation_response.data[0].url:
            return {"success": True,
                    "status": 200,
                    "message": "Image generated successfully!",
                    "image_url": image_generation_response.data[0].url}
        else:
            return {"success": False, "status": 500, "message": "Internal server error", "image_url": ""}
